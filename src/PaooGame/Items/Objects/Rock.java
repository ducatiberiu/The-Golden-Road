...
public class Rock extends Objects{
    ...
    public Rock(RefLinks refLink, float x, float y)
    {
    ...
    {
        g.drawImage(Assets.rock, (int)(x - refLink.GetGameCamera().getxOffset()), (int)(y - refLink.GetGameCamera().getyOffset()), width, height, null);

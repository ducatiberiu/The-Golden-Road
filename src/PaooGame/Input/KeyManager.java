...
public class KeyManager implements KeyListener
{
    ...
    public boolean attack_key; // Flag pentru tasta Space apasata
    public boolean save; //Flag pentru tasta Enter apasata
    public boolean load; //Flag pentru tasta Escape apasata
    ...
    public void Update()
    {
        ...
        attack_key = keys[KeyEvent.VK_SPACE];

        save = keys[KeyEvent.VK_ESCAPE];
        load = keys[KeyEvent.VK_ENTER];
    }
     ...
     */
    @Override
    public void keyPressed(KeyEvent e) // cand o tasta e apasata atunci metoda se apeleaza
    {
     ...
     */
    @Override
    public void keyReleased(KeyEvent e) // inversul metodei keyPressed. Metoda e apelata cand se elibereaza o tasta
    {
